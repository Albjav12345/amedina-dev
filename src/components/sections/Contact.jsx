...
const Contact = () => {
    ...
    return (
        <section id="contact" className="py-10 md:py-32 relative overflow-hidden px-14 md:px-0">
            {/* Background Decor */}
            ...
            <div className="container mx-auto px-0 md:px-6 relative z-10">
                <div className="max-w-4xl mx-auto glass-card p-8 md:p-12 lg:p-20 border-white/5 relative bg-gradient-to-b from-white/[0.03] to-transparent text-center gpu-accelerated">
                    ...
                    >
                        ...
                        <div className="py-2 md:py-10 space-y-2 md:space-y-6">
                            <div className="flex flex-col items-center gap-1">
                                <span className="text-[10px] font-mono uppercase tracking-[0.3em] text-gray-500">Primary_Endpoint</span>
                                <div className="flex items-center gap-2 bg-white/5 border border-white/10 px-4 md:px-6 py-2 md:py-4 rounded-xl group/email relative hover:border-electric-green/30">
                                    <span className="text-lg md:text-2xl font-mono font-bold text-white tracking-tight">{email}</span>
                                    <button
                                        onClick={handleCopy}
                                        className="p-1.5 md:p-2 rounded-lg bg-white/5 hover:bg-electric-green/20 text-gray-400 hover:text-electric-green"
